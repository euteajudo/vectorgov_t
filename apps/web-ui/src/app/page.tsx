/**
 * Página inicial — dashboard com cards de estatísticas e atalhos.
 *
 * Por enquanto os números são mockados (TODO: integrar `/api/stats` quando
 * existir). Os atalhos levam para as principais features.
 */
